...
namespace Dan.Demo
{
    public class LeaderboardManager : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.Ranking.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            ...
            Leaderboards.Ranking.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.Ranking.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.Ranking.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
